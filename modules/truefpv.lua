--[[MODULE.title = "True FPV"
MODULE.author = "Shooter#5269"
MODULE.description = "Implements a world based first person view with crosshair draw."

MODULE.IgnoredWeapons = {
	['weapon_physgun'] = true,
	['gmod_tool'] = true
}
function MODULE:RestartHeadSize( client )
...
function MODULE:CalcView(ply, origin, angles, fov)
	...
	if IsValid(ax.gui.menu) or IsValid(ax.gui.characterMenu) then self:RestartHeadSize( ply )return end
    ...
    view.origin = head2.Pos + head2.Ang:Up() + Vector(0,0,4)
